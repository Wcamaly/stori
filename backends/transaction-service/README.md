...
# API REST en Go para transaction

Este proyecto es una API REST desarrollada en Go (Golang), diseñada para manejar infraestructura en transaction. Utiliza la arquitectura hexagonal para un diseño limpio y mantenible.
